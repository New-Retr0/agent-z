      ...
      <section aria-labelledby="primitives" className="flex flex-col gap-4">
        ...
        <div className="grid gap-3 md:grid-cols-2">
          <Capability
            ...
            title="Tools"
            body="Read: discord_api_read, members, pinned, emoji/automod lists. Mod writes: messages, reactions, pins, threads. Admin writes: staged kick/ban, channels, roles, bulk delete — confirm in Discord ephemeral or via MCP client. Same catalog everywhere; Postgres tier matrix gates execution."
          />
          <Capability
          ...
          <Capability
            ...
            title="Elicitation"
            body="High-impact admin tools create a pending action for Confirm/Cancel in Discord (or elicitation in Cursor/Claude). Direct execution requires matching tier and allowlists."
          />
        </div>
      </section>
