  ...
  server.registerTool(
    "recall_conversation",
    {
      ...
      description:
        ...
        "asked 'what were we just talking about?'. Limited to 50 turns per call. Agent Z replays " +
        "recent turns as native chat messages plus optional Oversight snippets — call this only when " +
        "you need more than that window.",
      inputSchema: {
        channelId: SNOWFLAKE,
  ...
  server.registerTool(
    "schedule_message",
    {
      ...
      description:
        ...
        "(/api/cron/scheduled-msgs; schedule in apps/web/vercel.json) drains pending rows and posts them. " +
