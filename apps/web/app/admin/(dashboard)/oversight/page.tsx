      ...
      <section className="flex flex-col gap-3">
        ...
        {stats.recent.length === 0 ? (
          <p className="text-sm text-zinc-500">
            ...
            <code className="font-mono">DISCORD_BOT_TOKEN</code> (the gateway sends{" "}
            <code className="font-mono">x-discord-gateway-token</code> with this value) are configured,
            then post a message in any monitored channel.
          </p>
        ) : (
