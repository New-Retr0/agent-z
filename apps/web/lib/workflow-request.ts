...
export function parseDiscordContext(value: unknown): DiscordInvocationContext | undefined {
  ...
  return {
    ...
    invokerUserId: optionalStringProp(value, "invokerUserId"),
    invokerUsername: optionalStringProp(value, "invokerUsername"),
    invokerGlobalName: optionalStringProp(value, "invokerGlobalName"),
  };
}
